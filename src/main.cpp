...
#if defined(NDEBUG)
# error "CambtCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "CambtCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    {
        nSubsidy = 500000000 * COIN;   //500M Premine
    }
        else
    {
        nSubsidy = 5 * COIN;
...
#ifdef ENABLE_WALLET
// cambtcoin: attempt to generate suitable proof-of-stake
...
{
    RenameThread("cambtcoin-loadblk");
