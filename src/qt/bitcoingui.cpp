    ...
    nWeight(0)
{
    //resize(900, 520);
	resize(1080, 662);
    setWindowTitle(tr("CambtCoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/cambtcoin"));
    setWindowIcon(QIcon(":icons/cambtcoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a CambtCoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/cambtcoin"), tr("&About CambtCoin"), this);
    aboutAction->setToolTip(tr("Show information about CambtCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for CambtCoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/cambtcoin"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/cambtcoin_testnet"));
            setWindowIcon(QIcon(":icons/cambtcoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/cambtcoin_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("CambtCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("CambtCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CambtCoin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid CambtCoin address or malformed URI parameters."));
    }
